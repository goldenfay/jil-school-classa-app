              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, row[indexName])}
                      role="checkbox"
                    ...
                    >
                      ...
                      {Object.values(row).map((val) => {
                        return <TableCell align="left">{val}</TableCell>;
                      })}
                      {withActions && (
                        <TableCell align="center">
                          {withActions &&
                            ...
                            actionButtons.map((btn) => {
                              ...
                              console.log(customtheme.palette[btn.color])
                              return (
                                  <Grid container justify="center" spacing={3}>
                                <ThemeProvider theme={customtheme}>
                                <Grid item xs={12} md={10} > <Button fullWidth
